...
# ╔═╡ 192b1ab4-a129-11ee-20c2-4b12a4ec45a4
using GLMakie
...
# ╔═╡ 031ad644-c2df-4358-baa5-5af4708709f2
begin
using Plots
xp = [0, 0, 0, 0, 1, 1, 1, 1];
yp = [0, 1, 0, 1, 0, 0, 1, 1];
...
# ╔═╡ 6832f198-2fa1-4803-a159-59b4b5e031b3
data = ((i, j, k, RGBf(i, j, k)) for i in 0:0.1:1,
                                     j in 0:0.1:1,
                                     k in 0:0.1:1)


# ╔═╡ 5458ed3d-db30-4e09-9d4b-2da65f731c02
x, y, z, color = (vec(getindex.(data, i)) for i in 1:4)


# ╔═╡ 8cd447ab-7fc6-405e-b842-3a90bfdab9ce
meshscatter(x, y, z; color, marker=Rect3((0,0,0), (1,1,1)))

# ╔═╡ 99f6031b-30dd-467b-aceb-3f1a8e791b29
mesh3d(xp,yp,zp; connections, xlabel="x", proj_type = :persp, linecolor=:black)
...
function part1(A)
	...
	ending_supports=is_supported_by[end-5:end]
	ending=B[end-5:end]
	n=non_disintegrable[end-5:end]
	println("$ending_supports $ending $n") 
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "b76a446beca9c1261d5fbb69142af244192a0d08"
...
git-tree-sha1 = "9375ede2188d0eac90714b18e82197e7c89f854a"
