...
# ╔═╡ 5f554d36-a3a9-11ee-103e-993a536471d4
using GraphsFlows

# ╔═╡ 671cf7b9-ca0a-415f-b67d-4d72c2a4355b
using SimpleGraphs

# ╔═╡ cbc8d61e-99ba-4ad4-bb22-2f57f9bc3521
using Graphs

# ╔═╡ 205e14b2-ad75-4693-9d16-71d9491a16ac


# ╔═╡ 504cfa1f-ce76-4e0c-ab9a-4c1238decc34


# ╔═╡ 2a1cd9be-423e-43f9-9433-40009ac1f53d


# ╔═╡ bce2afb0-9e75-40d1-bd17-6d8d90963f32
# ╠═╡ disabled = true
#=╠═╡
g=SimpleGraphFromIterator(edgelist)
  ╠═╡ =#

# ╔═╡ bf8016fc-67cd-40e6-b5d9-5e50afabf20b
function parse_input(path)
	...
	for line in eachline(path)
		...
		s=findfirst(x->x==component,components)
		for other in other_components
			if other in components
				d=findfirst(x->x==other,components)

			else
				push!(components,other)
				d=findfirst(x->x==other,components)
				
			end
			push!(edge_list,Graphs.SimpleGraphs.SimpleEdge(s,d))
		end
	end
	return edge_list,components
end

# ╔═╡ a6dc1760-8dc5-4ef3-8445-34158eb0d385


# ╔═╡ 428ecf6c-4c63-4ef2-9011-06836e6bcad9
edge_list, components=parse_input("day25.txt")

# ╔═╡ 7bf585ff-8899-46ea-af32-814cc1d50a51
g=SimpleGraphFromIterator(edge_list)

# ╔═╡ 0f004ded-9417-4496-9d66-dfbc76bec56c
cut=mincut(g)

# ╔═╡ 92fba62e-ac4b-460c-aa12-2421df94ab03
components

# ╔═╡ b9233757-7a69-4941-b42d-2202cb2e0149
GraphsFlows.mincut(SimpleDiGraph(g),1,2)

# ╔═╡ dad1a6f7-5666-4480-93d3-7323237c7dbc


# ╔═╡ 17f9fc52-9336-4f62-9238-711540bee3df
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "7d8e8c86521970ac60b829fa068f7c38466c145e"
...
[[deps.GraphsFlows]]
deps = ["Graphs", "JuMP", "LinearAlgebra", "Markdown", "SimpleTraits", "SparseArrays"]
git-tree-sha1 = "c00a68bafabb86a79b88d82b400dcecf653450f7"
